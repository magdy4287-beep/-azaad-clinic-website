const REQUIRED_ENV = [
  'DATABASE_URL',
  'AZAAD_EXPECTED_DATABASE_TARGET_FINGERPRINT',
  'APPWRITE_ENDPOINT',
  'APPWRITE_PROJECT_ID',
  'APPWRITE_API_KEY',
...
export function runtimeContract() {
  ...
  return {
    ...
    expectedDatabaseTargetFingerprint: String(process.env.AZAAD_EXPECTED_DATABASE_TARGET_FINGERPRINT || '').trim(),
    ...
    retiredProviderRuntimeAllowed: false,
    configured
  };
}
