...
const AZAAD_I18N = {
  ar: {
    "لوحة إدارة العيادة":"لوحة إدارة العيادة","اسم المستخدم":"اسم المستخدم","كلمة المرور":"كلمة المرور","تسجيل الدخول":"تسجيل الدخول",
    "🔐 تسجيل الدخول بحساب الموظف عبر Supabase Auth":"🔐 تسجيل الدخول بحساب الموظف عبر Supabase Auth",
    "لوحة إدارة عيادة أزاد للصحة النفسية":"لوحة إدارة عيادة أزاد للصحة النفسية","🔄 تحديث":"🔄 تحديث","🏥 الموقع":"🏥 الموقع","🚪 تسجيل الخروج":"🚪 تسجيل الخروج",
    "📅 إجمالي الحجوزات":"📅 إجمالي الحجوزات","🟡 قيد المراجعة":"🟡 قيد المراجعة","🟢 مؤكدة":"🟢 مؤكدة","🚦 حجوزات اليوم":"🚦 حجوزات اليوم",
    "📅 الحجوزات":"📅 الحجوزات","🧑‍⚕️ الأطباء":"🧑‍⚕️ الأطباء","🩺 الخدمات":"🩺 الخدمات","🕐 جداول الأطباء":"🕐 جداول الأطباء","📣 المنشورات والعروض":"📣 المنشورات والعروض","🚫 العطلات والإغلاقات":"🚫 العطلات والإغلاقات","🕘 ساعات العمل":"🕘 ساعات العمل","👥 الموظفون":"👥 الموظفون","⚙️ الإعدادات":"⚙️ الإعدادات","👤 حساب الإدارة":"👤 حساب الإدارة",
    "🔎 الاسم / الهاتف / رقم الحجز":"🔎 الاسم / الهاتف / رقم الحجز","كل الحالات":"كل الحالات","قيد المراجعة":"قيد المراجعة","مؤكد":"مؤكد","ملغي":"ملغي","مكتمل":"مكتمل",
    "➕ إضافة طبيب":"➕ إضافة طبيب","➕ إضافة خدمة":"➕ إضافة خدمة","➕ منشور جديد":"➕ منشور جديد","➕ إضافة إغلاق":"➕ إضافة إغلاق","اختر الطبيب":"اختر الطبيب","اختر طبيبًا.":"اختر طبيبًا.","مدة الموعد، البريك، وساعات كل يوم.":"مدة الموعد، البريك، وساعات كل يوم.",
    "لا يوجد أطباء.":"لا يوجد أطباء.","لا توجد خدمات.":"لا توجد خدمات.","✍️ تعديل":"✍️ تعديل","💾 حفظ":"💾 حفظ","🟢 نشط":"🟢 نشط","🔴 غير نشط":"🔴 غير نشط","اسم الطبيب":"اسم الطبيب","التخصص":"التخصص","الهاتف":"الهاتف","الحالة":"الحالة","اسم الخدمة":"اسم الخدمة","السعر":"السعر","الوصف":"الوصف",
    "⛔ ليس لديك صلاحية لتنفيذ هذا الإجراء.":"⛔ ليس لديك صلاحية لتنفيذ هذا الإجراء.","ليس لديك صلاحية.":"ليس لديك صلاحية.","جلسة الإدارة غير موجودة.":"جلسة الإدارة غير موجودة.","جلسة الإدارة منتهية.":"جلسة الإدارة منتهية.","لا توجد حجوزات مطابقة.":"لا توجد حجوزات مطابقة.","تعديل طبيب":"تعديل طبيب","إضافة طبيب":"إضافة طبيب","تعديل خدمة":"تعديل خدمة","إضافة خدمة":"إضافة خدمة","تم حفظ بيانات الطبيب.":"تم حفظ بيانات الطبيب.","تم حفظ بيانات الخدمة.":"تم حفظ بيانات الخدمة."
  },
  en: {
    ...
    "لوحة إدارة عيادة أزاد للصحة النفسية":"Azaad Clinic for Mental Health Administration","🔄 تحديث":"🔄 Refresh","🏥 الموقع":"🏥 Website","🚪 تسجيل الخروج":"🚪 Sign out",
    "📅 إجمالي الحجوزات":"📅 Total Appointments","🟡 قيد المراجعة":"🟡 Pending","🟢 مؤكدة":"🟢 Confirmed","🚦 حجوزات اليوم":"🚦 Today's Appointments",
    "📅 الحجوزات":"📅 Appointments","🧑‍⚕️ الأطباء":"🧑‍⚕️ Doctors","🩺 الخدمات":"🩺 Services","🕐 جداول الأطباء":"🕐 Doctor Schedules","📣 المنشورات والعروض":"📣 Posts & Offers","🚫 العطلات والإغلاقات":"🚫 Holidays & Closures","🕘 ساعات العمل":"🕘 Working Hours","👥 الموظفون":"👥 Staff","⚙️ الإعدادات":"⚙️ Settings","👤 حساب الإدارة":"👤 Administration Account",
    "🔎 الاسم / الهاتف / رقم الحجز":"🔎 Name / Phone / Booking Number","كل الحالات":"All statuses","قيد المراجعة":"Pending","مؤكد":"Confirmed","ملغي":"Cancelled","مكتمل":"Completed",
    "➕ إضافة طبيب":"➕ Add Doctor","➕ إضافة خدمة":"➕ Add Service","➕ منشور جديد":"➕ New Post","➕ إضافة إغلاق":"➕ Add Closure","اختر الطبيب":"Select doctor","اختر طبيبًا.":"Select a doctor.","مدة الموعد، البريك، وساعات كل يوم.":"Appointment duration, breaks, and daily hours.",
    "لا يوجد أطباء.":"No doctors found.","لا توجد خدمات.":"No services found.","✍️ تعديل":"✍️ Edit","💾 حفظ":"💾 Save","🟢 نشط":"🟢 Active","🔴 غير نشط":"🔴 Inactive","اسم الطبيب":"Doctor name","التخصص":"Specialty","الهاتف":"Phone","الحالة":"Status","اسم الخدمة":"Service name","السعر":"Price","الوصف":"Description",
    "⛔ ليس لديك صلاحية لتنفيذ هذا الإجراء.":"⛔ You do not have permission to perform this action.","ليس لديك صلاحية.":"You do not have permission.","جلسة الإدارة غير موجودة.":"Admin session is not available.","جلسة الإدارة منتهية.":"Admin session has expired.","لا توجد حجوزات مطابقة.":"No matching appointments.","تعديل طبيب":"Edit Doctor","إضافة طبيب":"Add Doctor","تعديل خدمة":"Edit Service","إضافة خدمة":"Add Service","تم حفظ بيانات الطبيب.":"Doctor details saved.","تم حفظ بيانات الخدمة.":"Service details saved."
  }
};

let azaadLanguage = localStorage.getItem("azaad_admin_language") || "ar";
function azaadNormalizeText(value){ return String(value || "").replace(/\s+/g," ").trim(); }
function azaadTranslate(root=document.body){
  ...
  nodes.forEach(n=>{ const key=azaadNormalizeText(n.nodeValue); if(map[key]) n.nodeValue=n.nodeValue.replace(key,map[key]); });
  root.querySelectorAll("input[placeholder],textarea[placeholder]").forEach(el=>{ const key=azaadNormalizeText(el.getAttribute("placeholder")); if(map[key]) el.setAttribute("placeholder",map[key]); });
  root.querySelectorAll("option").forEach(el=>{ const key=azaadNormalizeText(el.textContent); if(map[key]) el.textContent=map[key]; });
}
function azaadSetLanguage(lang){
  azaadLanguage=lang === "en" ? "en" : "ar";
  localStorage.setItem("azaad_admin_language",azaadLanguage);
  document.documentElement.lang=azaadLanguage; document.documentElement.dir=azaadLanguage === "en" ? "ltr" : "rtl";
  const button=document.getElementById("azaadLanguageToggle"); if(button) button.textContent=azaadLanguage === "ar" ? "🇬🇧 English" : "🇪🇬 العربية";
  azaadTranslate(document.body);
}
function azaadInstallLanguageSwitch(){
  if(document.getElementById("azaadLanguageToggle")) return;
  const button=document.createElement("button"); button.id="azaadLanguageToggle"; button.type="button"; button.className="btn btn-secondary"; button.style.fontWeight="800";
  button.onclick=()=>azaadSetLanguage(azaadLanguage === "ar" ? "en" : "ar");
  const loginCard=document.querySelector("#loginPage .login-card"); const topActions=document.querySelector(".topbar .top-actions");
  if(topActions) topActions.prepend(button); else if(loginCard) loginCard.prepend(button);
  azaadSetLanguage(azaadLanguage);
}
const azaadLanguageObserver=new MutationObserver(mutations=>{ if(azaadLanguage !== "ar") mutations.forEach(m=>m.addedNodes.forEach(n=>{ if(n.nodeType===1) azaadTranslate(n); })); });
document.addEventListener("DOMContentLoaded",()=>{ azaadInstallLanguageSwitch(); azaadLanguageObserver.observe(document.body,{childList:true,subtree:true}); });
'''.strip()
...
async function admin(''', text, count=1, flags=re.S)
  ...
  let result = await request();
  if(result.response.status === 401){
    try { await azaadEnsureFreshSession(); } catch (_) { throw new Error("جلسة الإدارة منتهية."); }
    result = await request();
  }
  if(!result.response.ok) throw new Error(result.body?.error || result.body?.message || `HTTP ${result.response.status}`);
  return result.body;
}
...
'''
    text = re.sub(re.escape(marker) + r'.*?(?=</script>)', lambda _: tail, text, count=1, flags=re.S)

    if "const AZAAD_I18N =" not in text:
        injection = "\n\n<script>\n" + ADMIN_I18N + "\n</script>\n"
        text = re.sub(r'</body>', lambda _: injection + '</body>', text, count=1, flags=re.I)
