/* AZAAD CLINIC — PATIENT SESSION BRIDGE v5.0.0 */
(() => {
  'use strict';

  const SESSION_KEY = 'azaad_admin_token';
  const ADMIN_FUNCTION = 'https://derofsthjivlkcdnojww.supabase.co/functions/v1/azaad-admin';
  const I18N_SCRIPT = './central-i18n.js?v=2026.08.14.1';
  const ENHANCEMENTS_SCRIPT = './admin-enhancements-v1.js?v=2026.08.14.1';
  ...
  function restoreAdmin() {
    ...
    if (!restorePromise) {
      restorePromise = restoreAdminInternal().finally(() => { restorePromise = null; });
    }
