...
print("[AZAAD final admin isolation] PASS: exactly one executable lazy panel-loader definition remains inside the canonical registry; duplicate legacy definitions are forbidden")
