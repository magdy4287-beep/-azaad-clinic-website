...
check('purchasing: dedicated server boundary exists', purchases_api_path.exists() and 'clinic_purchases' in purchases_api and 'appwrite-neon' in purchases_api and "'purchases'" in gateway)
