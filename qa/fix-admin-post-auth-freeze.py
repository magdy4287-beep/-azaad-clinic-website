...
# The Cairo business-date owner is azaad-core-context.js. Admin waits only for
# that canonical owner to become available; it never implements a second date
# calculation or dynamically imports/duplicates the core runtime.
...
# Late build transform must never reintroduce the retired navigation owner.
...
print('[AZAAD] deterministic Admin logout + canonical Cairo-context readiness + shell-owned navigation applied')