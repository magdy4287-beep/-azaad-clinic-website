...
# A failed/slow data request must never hold the Admin UI hostage. The UI is
# made interactive first; data loading becomes best-effort background work.
...
# Logout is an emergency control: never wait indefinitely for a backend response.
