...
checks = [
    ...
    # The transform itself must contain a fail-closed assertion for the retired
    # endpoint family; the exact fetch syntax is generated by an earlier
    # canonicalizer and is deliberately not required in this transform source.
