...
PREPAINT = '''<style id="azaad-i18n-prepaint">html[data-azaad-i18n-pending="1"] body{visibility:hidden}</style>\n<script id="azaad-i18n-bootstrap">(()=>{const done=()=>{document.documentElement.dataset.azaadI18nPending="0"};try{const a=localStorage.getItem("azaad_admin_lang"),b=localStorage.getItem("azaadClinicLanguage"),l=(a==="en"||a==="ar"?a:(b==="en"||b==="ar"?b:(document.documentElement.lang||"ar").toLowerCase().startsWith("en")?"en":"ar"));const d=document.documentElement;d.lang=l;d.dir=l==="en"?"ltr":"rtl";d.dataset.language=l;d.dataset.azaadI18nPending="1";window.addEventListener("azaadLanguageChanged",done);document.addEventListener("DOMContentLoaded",()=>setTimeout(done,1500),{once:true});}catch(_){done()}})();</script>'''
