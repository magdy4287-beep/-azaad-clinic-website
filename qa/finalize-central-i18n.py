#!/usr/bin/env python3
"""Canonicalize production HTML to one central i18n runtime without a second UI translator."""
...
print(f'central i18n production canonicalization: {changed} HTML surface(s), removed {removed} prior runtime tag(s)')
