...
if not PATIENTS.exists():
    ...
    required = {
        ...
        "appointment date filter": "appointment_date",
        "appointment search": "booking_code",
        "appointment API": "api/admin-appointments?api=patient",
        "patient API": "api/admin-appointments?api=patients",
