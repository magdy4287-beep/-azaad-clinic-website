...
require('data-role' in read(ROOT/'admin.js'),'admin does not expose authenticated role to UI shell');require(all(x in ft for x in ('OWNER','ADMIN','MANAGER','CASHIER')),'RCM finance role scope missing')
