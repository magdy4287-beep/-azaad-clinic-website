...
SQL
# Do not use pg_restore --clean against an unknown dependency graph. The authoritative dump is restored into the controlled target with existing target objects preserved; this avoids destructive CASCADE cleanup.
