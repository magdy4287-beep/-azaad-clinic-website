...
SQL
pg_restore --exit-on-error --no-owner --no-privileges --section=pre-data --use-list="$work/restore.list" --dbname="$NEON_DATABASE_URL" "$work/public.restore.dump"; echo 'PASS: authoritative pre-data restore.'
...
pg_restore --exit-on-error --no-owner --no-privileges --disable-triggers --section=data --use-list="$work/restore.list" --dbname="$NEON_DATABASE_URL" "$work/public.restore.dump"; echo 'PASS: authoritative data restore.'
pg_restore --exit-on-error --no-owner --no-privileges --section=post-data --use-list="$work/restore.list" --dbname="$NEON_DATABASE_URL" "$work/public.restore.dump"; echo 'PASS: authoritative post-data restore.'
